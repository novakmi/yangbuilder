...
===== Methods from `PluginTreeNodeBuilder`

* `registerPlugin`
* `unregisterPlugin`
* `getNumberOfRegisteredPlugins`

===== Methods from `TextPluginTreeNodeBuilder`
...
==== <<nodebuilder>> node interface

From `BuilderNode`

===== Attributes from `BuilderNode`
...
===== Methods from `BuilderNode`

* `getNodePath`
* `shallowCopy`

==== <<nodebuilder>>  plugin interface

===== Methods from `NodeBuilderPlugin`

* `reset`
* `setMyBuilder`
* `getMyBuilder`

=== <<yangbuilder>> interface
