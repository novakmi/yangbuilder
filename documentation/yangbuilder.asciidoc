...
module example1-module {                                                                        //<1>
    /* This yang file was generated with groovy YangBuilder on Wed Apr 04 22:53:11 CEST 2012
       see http://bitbucket.org/novakmi/yangbuilder */
...
@GrabResolver(name = 'novakmirepo',
              root = 'https://github.com/novakmi/novakmirepo/raw/master/releases',
              m2compatible = true)
...
builder.module(moduleName, pnl_namespace:'http://bitbucket.org/novakmi/yangbuilder',
